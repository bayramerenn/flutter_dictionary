...
import 'package:flutter_dictionary/util/app_widget.dart';
import 'package:flutter_dictionary/util/system_overlay.dart';
import 'package:flutter_dictionary/widget/homepage/bottom_sheet.dart';
import 'package:flutter_dictionary/widget/homepage/home_page_list_view.dart';
import 'package:flutter_dictionary/widget/homepage/search_box.dart';
import 'package:flutter_dictionary/widget/homepage/tdk_cover.dart';
...
class _HomePageState extends State<HomePage> {
            ...
            children: <Widget>[
              ...
              Expanded(
                child: Padding(
                  ...
                  child: getMenu(_isKeyboardVisible),
                ),
              ),
            ],
          ),
  ...
  Widget getMenu(bool isKeyboardVisible) {
    var text = _searchController.text;
    if (text != '') _searchPage.add(text);

    if (isKeyboardVisible) {
      print(_searchPage);
      return SearchPage(_searchPage);
    } else {
      _searchController.text = '';
      return HomePageListView(textWord: text);
    }
  }
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: Text(AppConstant.appVersion,
                            style: TextStyle(
                                fontSize: 12,
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: MaterialButton(
                  ...
                  shape: RoundedRectangleBorder(
                      borderRadius: new BorderRadius.circular(8)),
                  child: Text(AppConstant.iletisim,
                      style: TextStyle(
                          fontSize: 14,
                          fontWeight: FontWeight.bold,
                          color: AppConstant.colorHeading)),
